...
import com.GUI.Chart.CurveChart.blankchart.BlankPlotChart;
import com.GUI.Chart.CurveChart.blankchart.BlankPlotChatRender;
import com.GUI.Chart.CurveChart.blankchart.SeriesSize;
...
public class CurveChart extends javax.swing.JPanel {
    ...
    private List<ModelLegendCurveChart> legends = new ArrayList<>();
    private List<ModelCurveChart> model = new ArrayList<>();
    ...
    public void addLegend(String name, Color color, Color color1) {
        ModelLegendCurveChart data = new ModelLegendCurveChart(name, color, color1);
        legends.add(data);
    ...
    public void addData(ModelCurveChart data) {
        model.add(data);
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.GUI.Chart.CurveChart.blankchart.BlankPlotChart();
    ...
    private com.GUI.Chart.CurveChart.blankchart.BlankPlotChart blankPlotChart;
